...
DDT_SWINGBOY_CFG = ArticulationCfg(
    spawn=sim_utils.UrdfFileCfg(
        ...
        asset_path=f"{DDT_MODEL_DIR}/swingboy_description/urdf/robot.urdf",
    ...
    init_state=ArticulationCfg.InitialStateCfg(
        ...
        joint_pos={
            ...
            "left_knee": 0.6161017167,
            "right_hip": 2.2689280276,
            "right_knee": 0.6161017167,
            ".*_wheel": 0.0,
        },
        joint_vel={".*": 0.0},
    ),
    # The hip default is the measured hard-limit calibration value. Shrinking
    # the soft range would move every reset away from the standing pose.
    soft_joint_pos_limit_factor=1.0,
    actuators={
        "legs": DCMotorCfg(
            joint_names_expr=[".*_(hip|knee)"],
            effort_limit=30.5,
            saturation_effort=30.5,
            velocity_limit=15.49,
            stiffness=30.0,
            damping=1.0,
            friction=0.0,
        ),
        "wheels": ImplicitActuatorCfg(
            ...
            effort_limit_sim=19.94,
            velocity_limit_sim=24.18,
            stiffness=0.0,
            damping=1.0,
            friction=0.0,
        ),
